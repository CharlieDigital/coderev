import { GenerateAccountRequest, GenerateAccountResponse } from './../../shared/messageModels';
...
export const generateAccount = functions
  .https.onCall({
    ...
    maxInstances: 5,
    timeoutSeconds: 240
  }, async (request: functions.https.CallableRequest<GenerateAccountRequest>) => {
    ...
    const { username, workspaceUid, createdBy } = request.data;
